...
//https://github.com/takezoh/php-PunycodeEncoder/blob/master/punycode.php
	...
	public static function digit2codepoint($d)
	{
		if ($d < 26) {
			// 0..25 : 'a'..'z'
			return $d + ord('a');
	...
	public static function codepoint2digit($c)
	{
		if ($c - ord('0') < 10) {
			// '0'..'9' : 26..35
			return $c - ord('0') + 26;
	...
	public static function rstrpos($haystack, $needle)
	{
	...
	public static function mb_strinsert($haystack, $needle, $position)
	{
		$old_encoding = mb_internal_encoding();
		mb_internal_encoding("UTF-8");
	...
	public static function mb_substr($str,$start,$length)
	{
		$old_encoding = mb_internal_encoding();
		mb_internal_encoding("UTF-8");
