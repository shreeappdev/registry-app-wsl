...
<body>
    <div class="fwd">
        ...
        <table>
            <tr>
                <td colspan="4">Domain Name: {{$domain_name}}  </td>
            </tr>
            <tr>
        ...
        <table>
            ...
            <tr>
                <td colspan="3">Organisation: <i>{{$organisationOrgName}}</i></td>
            </tr>
            <tr>
        ...
        <table>
            ...
            <tr>
                <td colspan="3">Organisation: <i>{{$adminOrgName}}</i></td>
            </tr>
            <tr>
        ...
        <div class="declare">
            ...
            <ol type="1">
                <li>
                    I as head of the organization acknowledge that <strong><i>{{$organisationOrgName}}</i></strong> meets all
        ...
        <div class="fwdauth">
            <table>
                ...
                <tr>
                    <td>Name & Designation: <i>{{$organisationOrgName}}</i></td>
