  ...
  <script src="{{asset('theme/userdashboard/assets/js/core/popper.min.js')}}"></script>
  <script src="{{asset('theme/userdashboard/assets/js/core/bootstrap.min.js')}}"></script>
  <script src="{{asset('theme/userdashboard/assets/js/plugins/perfect-scrollbar.min.js')}}"></script>
  <script src="{{asset('theme/userdashboard/assets/js/plugins/smooth-scrollbar.min.js')}}"></script>
  <script src="{{asset('theme/userdashboard/assets/js/plugins/chartjs.min.js')}}"></script>
  <script src="{{asset('theme/userdashboard/assets/js/plugins/swiper-bundle.min.js')}}" type="text/javascript"></script>
  <script src="{{asset('theme/userdashboard/assets/js/sweetalert2.all.min.js')}}"></script>
  <script>
  ...
  <script src="{{ asset('theme/userdashboard/assets/js/corporate-ui-dashboard.min.js?v=1.0.0')}}"></script>
