...
<head>
  ...
  <link href="{{ asset('theme/frontend/assets/vendor/bootstrap-icons/bootstrap-icons.css')}}" rel="stylesheet">
  <link href="{{ asset('theme/frontend/assets/vendor/boxicons/css/boxicons.min.css')}}" rel="stylesheet">
  <link href="{{ asset('theme/frontend/assets/vendor/glightbox/css/glightbox.min.css')}}" rel="stylesheet">
  <link href="{{ asset('theme/frontend/assets/vendor/remixicon/remixicon.css')}}" rel="stylesheet">
  <link href="{{ asset('theme/frontend/assets/vendor/swiper/swiper-bundle.min.css')}}" rel="stylesheet">
  <link href="{{ asset('theme/frontend/assets/css/style.css')}}" rel="stylesheet">

  <link href="{{ asset('theme/frontend/assets/fontawesome-free/css/all.min.css')}}" rel="stylesheet">
  @livewireStyles
</head>
