...
return [
    ...
    */
    ...
    'options' => [
        ...
        'fonts' => [
            'NotoSansDevanagari' => [
                'normal' => storage_path('fonts/NotoSansDevanagari.ttf'),
                'bold' => storage_path('fonts/NotoSansDevanagari.ttf'),
                'italic' => storage_path('fonts/NotoSansDevanagari.ttf'),
                'bold_italic' => storage_path('fonts/NotoSansDevanagari.ttf'),
            ],
        ],
